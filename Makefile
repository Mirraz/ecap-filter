...
ecap_adapter_filter.so: adapter_filter.o Debug.o cdebug.o filter.o uri_parser.o map.o
	$(LD) -o $@ $^ $(LDFLAGS)
...
cdebug.o: cdebug.cpp cdebug.h Debug.h Makefile
	$(CPPC) -o $@ $< -c $(CPPFLAGS)

filter.o: filter.c filter.h cdebug.h uri_parser.h map.h Makefile
	$(CC) -o $@ $< -c $(CFLAGS)
